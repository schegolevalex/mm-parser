...
@Component
public class BackToPromoStepDiscountButtonHandler extends BaseHandler {

    public BackToPromoStepDiscountButtonHandler(Context context) {
        super(context);
    }
    ...
    public boolean isSuitable(Update update) {
        return update.hasMessage()
               ...
               && update.getMessage().getText().equals(Constant.Button.BACK_TO_PROMO_STEP_DISCOUNT);
    }
}
