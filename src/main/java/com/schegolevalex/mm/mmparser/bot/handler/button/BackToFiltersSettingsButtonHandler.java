...
@Component
public class BackToFiltersSettingsButtonHandler extends BaseHandler {

    public BackToFiltersSettingsButtonHandler(Context context) {
        super(context);
    }
    ...
    public boolean isSuitable(Update update) {
        return update.hasMessage()
               ...
               && update.getMessage().getText().equals(Constant.Button.BACK_TO_FILTERS_SETTINGS);
    }
}
