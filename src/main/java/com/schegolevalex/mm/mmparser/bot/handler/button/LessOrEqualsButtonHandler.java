...
@Component
public class LessOrEqualsButtonHandler extends BaseHandler {
    public LessOrEqualsButtonHandler(Context context) {
        super(context);
    }
    ...
    public boolean isSuitable(Update update) {
        return update.hasMessage()
               ...
               && update.getMessage().getText().equals(Constant.Button.LESS_OR_EQUALS);
    }
}
