...
public interface Constant {
    ...
    interface Message {
        ...
        String HELP = """
                     ...
                     1. Чтобы начать пользоваться ботом, выберите или введите команду /start
                                
                     2. В настройках бота укажите Ваш текущий уровень 🟢 Сберпрайм (можно посмотреть в личном кабинете на сайте megamarket.ru)
                                
                     3. В настройках бота добавьте 🔵 промокод, если он у Вас имеется (можно посмотреть в в личном кабинете на сайте megamarket.ru)
                                
                     4. В настройках бота добавьте 🔴 фильтры для последующего отсеивания ненужных предложений по товарам
                                
                     5. Добавьте ссылку на товар. При нажатии на кнопку "🛒 мои товары" можно посмотреть список добавленных товаров, а так же применить к нему фильтры и промокоды, добавленные раннее
                                
                     Бот будет присылать уведомления с предложениями, подходящими под Ваши параметры, таким образом Вы не пропустите выгодные предложения.
                                
                     Чтобы остановить бота, выберите или введите команду /stop
                """;
    }
