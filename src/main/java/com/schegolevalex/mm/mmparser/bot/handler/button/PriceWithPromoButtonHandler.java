...
@Component
public class PriceWithPromoButtonHandler extends BaseHandler {
    public PriceWithPromoButtonHandler(Context context) {
        super(context);
    }
    ...
    public boolean isSuitable(Update update) {
        return update.hasMessage()
               ...
               && update.getMessage().getText().equals(Constant.Button.PRICE_WITH_PROMO);
    }
}
