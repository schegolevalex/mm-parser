...
@Component
public class SettingsButtonHandler extends BaseHandler {
    public SettingsButtonHandler(Context context) {
        super(context);
    }
    ...
    public boolean isSuitable(Update update) {
        return update.hasMessage()
               ...
               && update.getMessage().getText().equals(Constant.Button.SETTINGS);
    }
}
