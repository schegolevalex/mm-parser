...
@Component
public class PriceWithPromoAndBonusesButtonHandler extends BaseHandler {
    public PriceWithPromoAndBonusesButtonHandler(Context context) {
        super(context);
    }
    ...
    public void handle(Update update) {
        ...
        filter.setField(FilterField.PRICE_WITH_PROMO_AND_BONUSES);
    ...
    public boolean isSuitable(Update update) {
        return update.hasMessage()
               ...
               && update.getMessage().getText().equals(Constant.Button.PRICE_WITH_PROMO_AND_BONUSES);
    }
}
